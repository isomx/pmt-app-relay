...
[`src/index.js`](client/index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
in all web browsers. Service worker registration [won't be attempted](client/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](client/registerServiceWorker.js), which
